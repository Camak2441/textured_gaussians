...
namespace gsplat
{
    ...
    __global__ void rasterize_to_pixels_fwd_textured_gausssigs_kernel(
        ...
        const float s_weight)
    {
        ...
        if (cudaFuncSetAttribute(
                rasterize_to_pixels_fwd_textured_gausssigs_kernel<CDIM, float>,

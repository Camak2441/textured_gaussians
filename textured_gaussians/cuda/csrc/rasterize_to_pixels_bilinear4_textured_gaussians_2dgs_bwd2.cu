...
namespace gsplat
{
    ...
    __global__ void rasterize_to_pixels_bwd2_bilinear4_textured_gaussians_kernel(
        ...
        bool absgrad)
    {
        ...
        if (n_isects)
        {
            ...
            if (cudaFuncSetAttribute(
                    rasterize_to_pixels_bwd2_bilinear4_textured_gaussians_kernel<CDIM, float>,
...
#define __GS__CALL_(N)                                     \
    case N:                                                \
        return call_bwd2_tg4_kernel_with_dim<N>(           \
            means2d,                                       \
            ray_transforms,                                \
            colors,                                        \
            opacities,                                     \

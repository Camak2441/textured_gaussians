...
namespace gsplat
{
    ...
    std::tuple<
        ...
        torch::Tensor,
        torch::Tensor>
    call_bwd_aniso_g_kernel_with_dim(
        // Gaussian parameters
...
#define __GS__CALL_(N)                                     \
    case N:                                                \
        return call_bwd_aniso_g_kernel_with_dim<N>(        \
            means2d,                                       \
            ray_transforms,                                \
            colors,                                        \
            opacities,                                     \

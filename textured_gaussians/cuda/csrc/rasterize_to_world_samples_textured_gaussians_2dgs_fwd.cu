...
namespace gsplat
{
     ...
     */
    template <typename S>
    __global__ void rasterize_to_world_samples_fwd_implicit_textured_gaussians_kernel(
        ...
        const float opac_threshold)
    {
        ...
        if (cudaFuncSetAttribute(
                rasterize_to_world_samples_fwd_implicit_textured_gaussians_kernel<float>,

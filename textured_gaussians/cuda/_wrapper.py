...
tgs_fns = {
    ...
    "dct3": (f"{PRE}fwd_dct3{TGSPOST}", f"{PRE}bwd_dct3{TGSPOST}", False),
    "dct3_bwd2": (f"{PRE}fwd_dct3{TGSPOST}", f"{PRE}bwd_dct3{TGSPOST}", True),
}
...
@torch.no_grad()
def rasterize_dct3_textures(
    textures: Tensor,
    width: int,
    height: int,
    tile_size: int,
) -> Tuple[Tensor, Tensor, Tensor]:
    colors = _make_lazy_cuda_func("rasterize_dct3_textures")(
        textures,
        width,
        height,
        tile_size,

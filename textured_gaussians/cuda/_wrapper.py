...
class _RasterizeToPixelsAnisoBilinearTexturedGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        (
            ...
            gs_contrib_sum,
            gs_contrib_count,
        ) = _make_lazy_cuda_func("rasterize_to_pixels_fwd_aniso_bilinear_textured_gaussians")(
            means2d,
            ray_transforms,
            colors,
            opacities,
    ...
    def backward(
        ...
        (
            ...
            v_normals,
            v_densify,
        ) = _make_lazy_cuda_func("rasterize_to_pixels_bwd_aniso_bilinear_textured_gaussians")(
            means2d,
            ray_transforms,
            colors,
            opacities,

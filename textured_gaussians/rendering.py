...
from .cuda._wrapper import (
    ...
    rasterize_to_pixels_textured_gausssigs,
...
def rasterization_textured_gaussians(
    ...
    Args:
        ...
        opacities: The opacities of the Gaussians. [N]
        colors: The colors of the Gaussians. [(C,) N, D] or [(C,) N, K, 3] for SH coefficients.
        textures: The 2D texture maps associated with the Gaussians. [N, th, tw, 4].
        viewmats: The world-to-cam transformation of the cameras. [C, 4, 4]
        Ks: The camera intrinsics. [C, 3, 3]
        width: The width of the image.
        height: The height of the image.
...
def rasterization_implicit_textured_gaussians(
    ...
    Args:
        ...
        opacities: The opacities of the Gaussians. [N]
        colors: The colors of the Gaussians. [(C,) N, D] or [(C,) N, K, 3] for SH coefficients.
        textures: The texture model associated with the Gaussians. [N, th, tw, 4].
        viewmats: The world-to-cam transformation of the cameras. [C, 4, 4]
        Ks: The camera intrinsics. [C, 3, 3]
        width: The width of the image.
        height: The height of the image.
...
def rasterization_dct_textured_gaussians(
    means: Tensor,
    quats: Tensor,
    scales: Tensor,
    opacities: Tensor,
...
def rasterization_textured_gausssigs(
    means: Tensor,
    quats: Tensor,
    scales: Tensor,
    opacities: Tensor,
    ...
    """Rasterize Textured GaussSig splats to pixels.

    Combines bilinear texture lookup with a blended visibility kernel:
    ``vis = gaussian * g_weight + sigmoid * s_weight + (1 - g_weight - s_weight)``.
    ...
    Args:
        ...
        width: Image width.
        height: Image height.
        g_weight: Weight for Gaussian kernel (0-1). Default: 0.5.
        s_weight: Weight for smooth-step sigmoid kernel (0-1). Default: 0.5.

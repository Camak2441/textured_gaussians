...
__version__ = None
exec(open("textured_gaussians/version.py", "r").read())

URL = "https://github.com/bchao1/textured-gaussians"
...
def get_extensions():
    ...
    extensions_dir_v2 = osp.join("textured_gaussians", "cuda", "csrc")
    ...
    if sys.platform == "win32":
        define_macros += [("textured_gaussians_EXPORTS", None)]
    ...
    glm_path = os.path.join(current_dir, "textured_gaussians", "cuda", "csrc", "third_party", "glm")
    extension_v2 = CUDAExtension(
        "textured_gaussians.csrc",
        sources_v2,
...
setup(
    ...
    extras_require={
        # dev dependencies. Install them by `pip install textured_gaussians[dev]`
        "dev": [

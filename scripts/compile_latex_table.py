...
def build_table(models, scenes, results_dir):
    ...
    for i, model in enumerate(models):
        ...
        model_header += rf' & \multicolumn{{{n_metrics}}}{{c}}{{{model}}}'
...
def main():
    parser = argparse.ArgumentParser(description='Compile a LaTeX table from eval results')
    ...
    table = build_table(args.models, args.scenes, args.results_dir)

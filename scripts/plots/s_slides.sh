python plot_metric_diff.py \
    ...
    --model-overrides \
    "2dgs_sfm:NeRF-Synthetic=2dgs_g2000" \
    "2dgs_sfm_oquad1-1000:NeRF-Synthetic=2dgs_g2000_oquad1-1000" \
    "2dgss_g9833_sfm_oquad1-1000_swc08:NeRF-Synthetic=2dgss_g1966_oquad1-1000_swc08" \
    --metrics psnr ssim lpips cvvdp \
    --fig-width 2 \
    --fig-height 4 \
    --output ../results/plots/s.png

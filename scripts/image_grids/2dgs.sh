...
python image_grid.py \
    ...
    --row_models "chair,30,gt,2dgs_g2000,2dgss_g1966_oquad1-1000_swc08" \
    --row_models "lego,50,gt,2dgs_g2000,2dgss_g1966_oquad1-1000_swc08" \
    --row_models "mic,50,gt,2dgs_g2000,2dgss_g1966_oquad1-1000_swc08" \

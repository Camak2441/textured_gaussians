...
python image_grid.py \
    ...
    --models gt tgs_psfm tgs_b2_psfm \
    --col_labels "gt=Ground Truth" "tgs_psfm=TGS" "tgs_b2_psfm=TGS w/ TexGrad" \
    --scenes counter chair drums \
    --val_nums 9 12 3 \
    --val_ordering original \
    --row_labels "counter,9=Counter" \
    "chair,12=Chair" "drums,3=Drums" \
    --row_models "chair,12,gt,tgs_g2000,tgs_b2_g2000" \
    --row_models "drums,3,gt,tgs_g2000,tgs_b2_g2000" \
    --row_models "lego,5,gt,tgs_g2000,tgs_b2_g2000" \
    --row_models "mic,3,gt,tgs_g2000,tgs_b2_g2000" \
    --row_models "ship,5,gt,tgs_g2000,tgs_b2_g2000" \
    ...
    --output ../results/images/tgs_slides1.png
